...
import com.devcamp.shop24h.repository.OfficeRepo;
...
public class OfficeController {
	...
	public ResponseEntity<Object> updateOffice(@PathVariable Integer officeId, @Valid @RequestBody Office newOffice) {
		try {
			Optional<Office> officeFound = officeRepo.findById(officeId);
			if (officeFound.isPresent()) {
