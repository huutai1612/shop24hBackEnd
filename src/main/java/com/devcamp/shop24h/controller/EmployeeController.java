...
import com.devcamp.shop24h.repository.EmployeeRepo;
...
public class EmployeeController {
	...
	public ResponseEntity<Object> updateEmployee(@PathVariable Integer employeeId, @Valid @RequestBody Employee newEmployee) {
		try {
			Optional<Employee> employeeFound = employeeRepo.findById(employeeId);
			if (employeeFound.isPresent()) {
